	...
	echo -e "${blue}[4]DECRYPT CAP FILES${reset}"	
        ...
        case $method in
			...
			sleep 3
                        ...
                        sudo timeout 30s sudo airodump-ng wlan0mon
                        sleep 2
			...
			sleep 3
                        ...
                        sudo timeout 40s airodump-ng --bssid $bssid --channel $channel wlan0mon
                        sleep 2
		...
		3)
			...
			echo -e "\npress ctrl+c to stop ...." | lolcat
                        sleep 3
			sudo timeout 40s airodump-ng --bssid $bssid --channel $channel -w capture wlan0mon &
                        AirodumpPID=$!

			#handshake caputres
			echo -e"\nWAIT TO CAPTURE HANDSHAKE FILES, PRESS CTRL+C TO STOP :)" | lolcat
			sleep 3
                        sudo airodump-ng --bssid $bssid --channel $channel -w capture --ignore-negative-one wlan0mon
